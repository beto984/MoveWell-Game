namespace AngleSharp.Extensions
{
    ...
    static class DocumentExtensions
    {
        ...
        public static void ForEachRange(this Document document, Predicate<Dom.Collections.Range> condition, Action<Dom.Collections.Range> action)
        {
            foreach (var range in document.GetAttachedReferences<Dom.Collections.Range>())
            {
